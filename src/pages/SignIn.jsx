    ...
    <div className="flex justify-center items-center h-screen z-10 bg-[#0F252B] inner-shadow-main overflow-y-scroll touch" style={{boxShadow: "inset 0px 0px 200px 17px rgba(0,0,0,0.7)"}}>
      <div className="backdrop-blur-3xl bg-white/60 rounded-2xl p-6" style={{boxShadow: "inset 0px 0px 50px -2px rgba(255,255,255,.7),0px 12px 100px 22px rgba(0,0,0,1)"}}>
        ...
        <div className="max-w-3xl px-8 pb-4 mx-auto text-center">
          <h1 className="fancy text-3xl font-semibold text-black">Welcome back.</h1>
        </div>
        ...
        <div className="max-w-sm mx-auto">
          ...
          <form onSubmit={handleSubmit}>
            {loginError ?
              ...
              <span className="sm:inline block">The email or password was incorrect.</span>
              </div> : null
            }
            ...
            <div className="flex flex-wrap mb-4 -mx-3">
              <div className="w-full px-3">
                ...
                <input value={values.email} onChange={handleChange} name="email" id="email" type="email" autoComplete='email' className="focus:border-none focus:outline-none border-hidden w-full p-3 text-gray-800 rounded-lg" placeholder="Enter your email address" required />
              </div>
            </div>
            ...
            <div className="flex flex-wrap mb-4 -mx-3">
              <div className="w-full px-3">
                <div className="flex justify-between">
                  ...
                  <a href="/reset-password" className="hover:underline text-sm font-medium text-[#465943]">Forgot your password?</a>
                </div>
                {/* Password Input */}
                <input value={values.password} onChange={handleChange} id="password" type="password" name="password" autoComplete='current-password' className="focus:border-none focus:outline-none border-hidden w-full p-3 text-gray-800 rounded-lg" placeholder="Enter your password" required />
              </div>
            </div>
          ...
          <div className="mt-4 text-center text-gray-900">
            Are you new? <a href="/signup" className="hover:underline text-[#465943] transition duration-150 ease-in-out">Register</a>
          </div>
        </div>
